<!-- translated-from: README.md@34df4359f598105b0b5df46ace9e813f28ecbab0 -->
...
| 검색어 | 표시되는 것 |
|---|---|
| `["solved":0]` | 한 번도 통과하지 못한 유형 전부 |
| `path:problems` | 문제 자체. 내가 한 작업이 눈에 띕니다 |

둘 다 이 저장소가 이미 쓰고 있는 프론트매터를 읽습니다. 플러그인은 필요 없고, 저 회색 점들 중
무엇이 중요한지는 여기서 정하지 않습니다.
